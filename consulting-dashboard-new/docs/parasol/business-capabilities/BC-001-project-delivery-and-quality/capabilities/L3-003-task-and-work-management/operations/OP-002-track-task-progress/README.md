...
- **ERR_BC001_L3-003_002_001**: パラメータバリデーションエラー

#### HTTP 404 Not Found
- **ERR_BC001_L3-003_002_404**: リソースが存在しません

#### HTTP 500 Internal Server Error
- **ERR_BC001_L3-003_002_500**: システムエラー
...
### 副作用
- **ドメインイベント発行**: `TaskProgressUpdated`
- **BC間連携**: BC-002（コスト計上）
...
|--------|---------------|------|-------------|
| ERR_BC001_L3-003_002_001 | 400 | バリデーションエラー | No |
| ERR_BC001_L3-003_002_404 | 404 | リソース不存在 | No |
| ERR_BC001_L3-003_002_500 | 500 | システムエラー | Yes |

### リトライ戦略
- **リトライ可能エラー**: ERR_BC001_L3-003_002_500
- **リトライ回数**: 3回
