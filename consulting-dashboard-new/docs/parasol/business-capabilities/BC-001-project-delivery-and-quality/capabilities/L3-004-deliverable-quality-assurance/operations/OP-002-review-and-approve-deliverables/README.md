...
- **ERR_BC001_L3-004_002_001**: パラメータバリデーションエラー

#### HTTP 404 Not Found
- **ERR_BC001_L3-004_002_404**: リソースが存在しません

#### HTTP 500 Internal Server Error
- **ERR_BC001_L3-004_002_500**: システムエラー
...
- **Deliverable Aggregate**: 参照 [../../../../domain/README.md](../../../../domain/README.md)
  - 主要エンティティ: Deliverable, QualityReview
...
### 副作用
- **ドメインイベント発行**: `DeliverableApproved, DeliverableRejected`
- **BC間連携**: BC-007（レビュー通知）, BC-006（知識登録）
...
|--------|---------------|------|-------------|
| ERR_BC001_L3-004_002_001 | 400 | バリデーションエラー | No |
| ERR_BC001_L3-004_002_404 | 404 | リソース不存在 | No |
| ERR_BC001_L3-004_002_500 | 500 | システムエラー | Yes |

### リトライ戦略
- **リトライ可能エラー**: ERR_BC001_L3-004_002_500
- **リトライ回数**: 3回
