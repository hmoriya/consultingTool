...
- **ERR_BC001_L3-004_003_001**: パラメータバリデーションエラー

#### HTTP 404 Not Found
- **ERR_BC001_L3-004_003_404**: リソースが存在しません

#### HTTP 500 Internal Server Error
- **ERR_BC001_L3-004_003_500**: システムエラー
...
- **Deliverable Aggregate**: 参照 [../../../../domain/README.md](../../../../domain/README.md)
  - 主要エンティティ: Deliverable, DeliverableVersion
...
### 副作用
- **ドメインイベント発行**: `DeliverableVersionUpdated`
- **BC間連携**: なし
...
|--------|---------------|------|-------------|
| ERR_BC001_L3-004_003_001 | 400 | バリデーションエラー | No |
| ERR_BC001_L3-004_003_404 | 404 | リソース不存在 | No |
| ERR_BC001_L3-004_003_500 | 500 | システムエラー | Yes |

### リトライ戦略
- **リトライ可能エラー**: ERR_BC001_L3-004_003_500
- **リトライ回数**: 3回
