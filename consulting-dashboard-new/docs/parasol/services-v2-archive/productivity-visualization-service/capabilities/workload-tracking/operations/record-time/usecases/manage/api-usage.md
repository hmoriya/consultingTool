# API利用仕様: プロジェクト別工数を管理する

<!--
このファイルはIssue #146 API仕様WHAT/HOW分離統一化の一環で自動生成されました
WHAT（何ができるか）: services/productivity-visualization-service/api/api-specification.md
...
### 記入手順
1. **プロジェクト別工数を管理する**: 対応するusecase.mdのユースケース名を記入
