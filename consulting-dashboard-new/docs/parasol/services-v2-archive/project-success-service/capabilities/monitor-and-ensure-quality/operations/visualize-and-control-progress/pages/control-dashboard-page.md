...
|---------|----------|---------|------|---------------|------|
| 統制範囲 | ARRAY<STRING_50> | 複数選択 | ○ | 統制領域一覧 | 統制対象の範囲・領域 |
| 統制基準 | STRING_50 | 単一選択 | ○ | 基準・フレームワーク | 適用する統制基準・規格 |
| 評価頻度 | STRING_20 | 単一選択 | ○ | 日次/週次/月次 | 統制評価・監視の頻度 |
| しきい値 | PERCENTAGE | 数値入力 | ○ | 0-100の範囲 | 統制アラートのしきい値 |

### 監視条件
| 入力項目 | Parasol型 | 入力形式 | 必須 | バリデーション | 説明 |
|---------|----------|---------|------|---------------|------|
| 重点監視項目 | ARRAY<STRING_50> | 複数選択 | × | 監視項目一覧 | 特に注意深く監視する項目 |
| アラート設定 | ARRAY<STRING_50> | 複数選択 | × | アラート条件 | 通知・エスカレーションの条件 |
| 報告レベル | STRING_20 | 単一選択 | × | 詳細/標準/サマリー | 統制報告の詳細レベル |
| 権限レベル | STRING_20 | 単一選択 | ○ | 閲覧/編集/承認 | ユーザーの権限・アクセスレベル |
