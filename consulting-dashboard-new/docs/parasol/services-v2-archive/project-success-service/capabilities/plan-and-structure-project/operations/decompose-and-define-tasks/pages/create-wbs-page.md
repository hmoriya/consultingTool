...
|---------|----------|---------|------|---------------|------|
| プロジェクト名 | STRING_100 | テキスト入力 | ○ | 最大100文字 | WBS対象プロジェクト |
| 分解方法 | STRING_50 | 単一選択 | ○ | 方法一覧 | 成果物/フェーズ/機能ベース |
| 分解レベル | INTEGER | 数値入力 | ○ | 2-8の範囲 | 最大階層レベル数 |
| 番号体系 | STRING_50 | 単一選択 | ○ | 体系一覧 | 1.1.1/A.1.a等の採番方式 |

### WBS要素情報
| 入力項目 | Parasol型 | 入力形式 | 必須 | バリデーション | 説明 |
|---------|----------|---------|------|---------------|------|
| 作業名 | STRING_50 | テキスト入力 | ○ | 最大50文字 | WBS要素名称 |
| 作業説明 | TEXT | テキストエリア | ○ | 最大500文字 | 作業内容・目的・方法 |
| 成果物 | STRING_200 | テキスト入力 | × | 最大200文字 | 期待される成果物 |
| 担当者 | UUID | 選択リスト | × | メンバー一覧 | 責任者・実行者 |
