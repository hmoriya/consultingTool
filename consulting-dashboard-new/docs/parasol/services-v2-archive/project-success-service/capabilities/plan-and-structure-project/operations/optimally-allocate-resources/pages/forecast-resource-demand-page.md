...
|---------|----------|---------|------|---------------|------|
| 予測期間 | DATE | 日付範囲 | ○ | 現在以降の期間 | 需要予測の対象期間 |
| 予測手法 | STRING_50 | 単一選択 | ○ | 手法一覧 | 使用する予測モデル |
| 信頼度レベル | PERCENTAGE | 数値入力 | ○ | 80-99の範囲 | 予測の信頼区間（%） |
| 更新頻度 | STRING_20 | 単一選択 | ○ | 日次/週次/月次 | 予測の更新サイクル |

### シナリオ設定
| 入力項目 | Parasol型 | 入力形式 | 必須 | バリデーション | 説明 |
|---------|----------|---------|------|---------------|------|
| ベースケース | BOOLEAN | チェックボックス | ○ | 必須選択 | 標準的な予測シナリオ |
| 楽観シナリオ | BOOLEAN | チェックボックス | × | 任意選択 | 好調な場合の予測 |
| 悲観シナリオ | BOOLEAN | チェックボックス | × | 任意選択 | 不調な場合の予測 |
| カスタムシナリオ | STRING_200 | テキスト入力 | × | 最大200文字 | 独自シナリオの説明 |
