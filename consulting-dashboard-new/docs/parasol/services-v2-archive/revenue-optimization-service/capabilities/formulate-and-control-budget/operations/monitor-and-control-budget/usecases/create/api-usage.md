# API利用仕様: 予算統制レポートを作成する

<!--
このファイルはIssue #146 API仕様WHAT/HOW分離統一化の一環で自動生成されました
WHAT（何ができるか）: services/revenue-optimization-service/api/api-specification.md
...
|-----|---------------|----------|-----------|
| [API名1] | POST /api/revenue-optimization-service/[resource] | [利用目的の説明] | `param1`, `param2`, `param3` |
| [API名2] | GET /api/revenue-optimization-service/[resource]/{id} | [利用目的の説明] | `resourceId`, `includeDetails` |
| [API名3] | PUT /api/revenue-optimization-service/[resource]/{id} | [利用目的の説明] | `resourceId`, `updateData` |
### 他サービスAPI（ユースケース利用型）
...
### 記入手順
1. **予算統制レポートを作成する**: 対応するusecase.mdのユースケース名を記入
