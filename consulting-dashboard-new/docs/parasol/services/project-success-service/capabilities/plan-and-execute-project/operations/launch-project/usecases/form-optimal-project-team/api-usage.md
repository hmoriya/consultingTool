# API利用仕様: 最適なプロジェクトチームを編成する

<!--
このファイルはIssue #146 API仕様WHAT/HOW分離統一化の一環で自動生成されました
WHAT（何ができるか）: services/project-success-service/api/api-specification.md
...
### 記入手順
1. **最適なプロジェクトチームを編成する**: 対応するusecase.mdのユースケース名を記入
